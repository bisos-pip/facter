...
- [[#bisosfacter-as-an-example-of-command-services-pycs-----code-walkthrough][bisos.facter as an Example of Command Services (PyCS) --- Code Walkthrough]]
  ...
  - [[#py3bisosfacterfacterpy][./py3/bisos/facter/facter.py]]
...
File [[file:./py3/bin/facter.cs]] is a multi-unit

** ./py3/bisos/facter/facter.py

File [[file:./py3/bisos/facter/facter.py]] is a CSU.
